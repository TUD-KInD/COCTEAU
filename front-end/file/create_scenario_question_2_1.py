...
page_2_view_0 = scenario + bachelor_view + opinion_before

page_2_view_0 = deepcopy(page_2_view_0)
...
page_2_view_1 = scenario + master_view + opinion_before

page_2_view_1 = deepcopy(page_2_view_1)
for i in range(len(page_2_view_1)):
    page_2_view_1[i]["view"] = 1
...
page_2_view_2 = scenario + phd_view + opinion_before

page_2_view_2 = deepcopy(page_2_view_2)
for i in range(len(page_2_view_2)):
    page_2_view_2[i]["view"] = 2
...
page_2_view_3 = scenario + researcher_view + opinion_before

page_2_view_3 = deepcopy(page_2_view_3)
for i in range(len(page_2_view_3)):
    page_2_view_3[i]["view"] = 3
...
page_2_view_4 = scenario + professor_view + opinion_before

page_2_view_4 = deepcopy(page_2_view_4)
for i in range(len(page_2_view_4)):
    page_2_view_4[i]["view"] = 4

page_2 = page_2_view_0 + page_2_view_1 + page_2_view_2 + page_2_view_3 + page_2_view_4
...
page_3_mode_1 = deepcopy(page_3_mode_1)
for i in range(len(page_3_mode_1)):
    page_3_mode_1[i]["mode"] = 1
...
page_3_mode_2 = deepcopy(page_3_mode_2)
for i in range(len(page_3_mode_2)):
    page_3_mode_2[i]["mode"] = 2
...
page_3_mode_3 = deepcopy(page_3_mode_3)
for i in range(len(page_3_mode_3)):
    page_3_mode_3[i]["mode"] = 3

page_3 = page_3_mode_1 + page_3_mode_2 + page_3_mode_3

for i in range(len(page_3)):
    page_3[i]["page"] = 3
...
page_4_mode_1 = reflection_head + reflection_vote + reflection_motivation + reflection_image

page_4_mode_1 = deepcopy(page_4_mode_1)
for i in range(len(page_4_mode_1)):
    page_4_mode_1[i]["mode"] = 1

page_4_mode_2 = reflection_head + reflection_vote + reflection_motivation

page_4_mode_2 = deepcopy(page_4_mode_2)
for i in range(len(page_4_mode_2)):
    page_4_mode_2[i]["mode"] = 2

page_4_mode_3 = reflection_head + reflection_vote

page_4_mode_3 = deepcopy(page_4_mode_3)
for i in range(len(page_4_mode_3)):
    page_4_mode_3[i]["mode"] = 3

page_4 = page_4_mode_1 + page_4_mode_2 + page_4_mode_3

for i in range(len(page_4)):
    page_4[i]["page"] = 4
...
for i in range(len(page_5)):
    page_5[i]["page"] = 5

data = page_0 + page_1 + page_2 + page_3 + page_4 + page_5
