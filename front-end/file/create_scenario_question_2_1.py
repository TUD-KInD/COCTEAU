...
page_0 = [{
    ...
    "text": "<ul><li>You are a new Bachelor's student enrolled in UNIVERSITY.</li><li>You just moved into a dorm on campus.</li><li>You still keep in touch with high-school friends who live close to the campus.</li><li>You have a private room and a shared common area for socializing.</li><li>You have a part-time job on campus to help with the tuition fees.</li></ul>",
    "is_just_description": True,
    "page": 2
}, {
    ...
    "choices": [{
        ...
        "text": "The university should only allow fully vaccinated people to enter the campus.",
        "value": 2
    }, {
        "text": "The university should support the hybrid setting to enable both physical and virtual presence (for example, using scheduling systems or masks).",
        "value": 3
    }, {
        "text": "The university should only allow education activities on campus, and no other activities are allowed (e.g., social gatherings).",
        "value": 4
    }, {
    ...
    "text": "<ul><li>You are a PhD student just enrolled in the graduate program of UNIVERSITY.</li><li>You have weekly meetings with your supervisor and with the other PhD candidates.</li><li>While the university provided you with a working laptop, you still need to access some facilities on campus to carry out your work (e.g., using laboratory equipment).</li></ul>",
    "is_just_description": True,
    "page": 2,
    "view": 2
}, {
    ...
    "text": "This page shows a part of the motivations (randomly selected) that other people provided to support their opinions. Please take a look at them and choose the ones that make you <b>understand</b> or <b>resonate</b> with their point of view, considering both the text and image.",
    "is_just_description": True,
    "page": 3,
    "mode": 1
}, {
    "text": "<h3>The university should not allow people to work on campus, and all activities should be online.</h3><b class='custom-text-danger'>You may select none, single, or multiple ones.</b>",
    "choices": [{
        "text": {
    ...
    "text": "<h3>The university should only allow fully vaccinated people to enter the campus.</h3><b class='custom-text-danger'>You may select none, single, or multiple ones.</b>",
    "choices": [{
        "text": {
    ...
    "text": "<h3>The university should support the hybrid setting to enable both physical and virtual presence (for example, using scheduling systems or masks).</h3><b class='custom-text-danger'>You may select none, single, or multiple ones.</b>",
    "choices": [{
        "text": {
    ...
    "text": "<h3>The university should only allow education activities on campus, and no other activities are allowed (e.g., social gatherings).</h3><b class='custom-text-danger'>You may select none, single, or multiple ones.</b>",
    "choices": [{
        "text": {
    ...
    "text": "<h3>The university should allow people to work on campus without restrictions.</h3><b class='custom-text-danger'>You may select none, single, or multiple ones.</b>",
    "choices": [{
        "text": {
    ...
    "choices": [{
        "text": "The university should not allow people to work on campus, and all activities should be online. <span><b>(13 people vote for this option)</b></span>",
        "value": 1
    }, {
        "text": "The university should only allow fully vaccinated people to enter the campus. <span><b>(11 people vote for this option)</b></span>",
        "value": 2
    }, {
        "text": "The university should support the hybrid setting to enable both physical and virtual presence (for example, using scheduling systems or masks). <span><b>(16 people vote for this option)</b></span>",
        "value": 3
    }, {
        "text": "The university should only allow education activities on campus, and no other activities are allowed (e.g., social gatherings). <span><b>(14 people vote for this option)</b></span>",
        "value": 4
    }, {
        "text": "The university should allow people to work on campus without restrictions. <span><b>(10 people vote for this option)</b></span>",
        "value": 5
    }],
    "page": 3,
    "mode": 1
    ...
    "text": "<h3>The question on this page shows other people's votes. Please take a look at them and select your opinion again. As a reminder, below is the scenario.</h3>",
    "is_just_description": True,
    "page": 3,
    "mode": 3
}, {
    ...
    "text": "Please answer the following question regarding the previous step of rethinking your opinion.",
    "is_just_description": True,
    "page": 4,
    "mode": 3
}, {
